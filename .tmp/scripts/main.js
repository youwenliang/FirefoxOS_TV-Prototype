...
$(document).ready(function () {
	...
	// });
	TweenLite.to($('#app01'), scale_speed, { scaleX: 1.6, scaleY: 1.6, scaleZ: 1.6, z: 0.001, zIndex: 10, border: '6px #FFF solid', ease: Power4.easeInOut, delay: count * 160 / 1000, perspective: 1000, force3D: true, perspective: 1000, onComplete: function onComplete() {
			// Finish Loading
			flag = true;
