...
$(document).ready(function () {
	...
	TweenLite.to($('#app01'), scale_speed, { scaleX: 1.6, scaleY: 1.6, scaleZ: 1.6, z: 0.001, zIndex: 10, border: '6px #FFF solid', ease: Power1.easeInOut, delay: count * 160 / 1000, force3D: true, onComplete: function onComplete() {
			// Finish Loading
			flag = true;
 ...
 (think of all the interaction as components, what can be used again and again?)
	...
	(function ($) {
		$.fn.isSelected = function (s) {
			...
			if (this.hasClass('cardselected')) {
				...
				TweenLite.to(this, scale_speed, { border: '4px #FFF solid', borderTop: '4px #FFF solid', borderBottom: '4px #FFF solid', borderLeft: '4px #FFF solid', borderRight: '4px #FFF solid', scaleX: s, scaleY: s, scaleZ: s, z: 0.001, width: '300px', height: '300px', top: '-=92px', zIndex: 10, force3D: true, ease: Power4.easeInOut, perspective: 1000, onComplete: function onComplete() {
						flag = true;
					} });
			} else {
	...
	(function ($) {
		$.fn.notSelected = function (s) {
			...
			if (this.hasClass('cardselected')) {
				...
				TweenLite.to(this, scale_speed, { border: '0px #FFF solid', borderTop: '0px #FFF solid', borderBottom: '0px #FFF solid', borderLeft: '0px #FFF solid', borderRight: '0px #FFF solid', scaleX: s, scaleY: s, scaleZ: s, z: 0.001, width: notSelected_cardsize, height: notSelected_cardsize, top: '+=92px', zIndex: 1, force3D: true, ease: Power4.easeInOut, onComplete: function onComplete() {
						//flag = true;
					} });
			} else {
					TweenLite.to(this, scale_speed, { scaleX: s, scaleY: s, scaleZ: s, z: 0.001, zIndex: 1, border: '0px #989898 solid', ease: Power4.easeInOut, force3D: true, onComplete: function onComplete() {
							//flag = true;
						} });
				}
	...
	(function ($) {
		$.fn.isSelected_option = function (t) {
			t = t || .4;
			TweenLite.to(this, t, { backgroundColor: 'rgb(255,255,255)', scaleX: 1.3, scaleY: 1.3, scaleZ: 1.3, z: 0.001, force3D: true, ease: Power4.easeInOut, perspective: 1000, onComplete: function onComplete() {
					flag = true;
				} });
	...
	(function ($) {
		$.fn.notSelected_option = function (t) {
			t = t || .4;
			TweenLite.to(this, t, { backgroundColor: 'rgb(96,96,96)', scaleX: 1, scaleY: 1, scaleZ: 1, z: 0.001, force3D: true, ease: Power4.easeInOut, onComplete: function onComplete() {
					//flag = true;
				} });
	...
	(function ($) {
		$.fn.transition_closing = function (m) {
			...
			TweenLite.to(this, trans_speed - 1, { opacity: 0, force3D: true, ease: Power4.easeIn, onComplete: function onComplete() {
					if (m == "optionmode") {
				...
				if (flag) {
					if (mode == "navigation") {
						...
						$('#' + $current.attr('id') + ' > .appbutton-folder').each(function (index, element) {
							...
							TweenLite.to(this, .001, { width: notSelected_cardsize, height: notSelected_cardsize, marginLeft: cardoffset + (notSelected_cardsize + 10) * k + 'px', bottom: '-150px', force3D: true, delay: .3 });
						});
				...
				//Arrow Keys UP
						...
						if (flag) if (mode == "navigation") {
							...
							// Filter
									...
									/******************************************************************************/ //backagain***
									TweenLite.to($('#app'), .3, { y: '+=100px', z: 0.001, force3D: true, ease: Power2.easeInOut });
									$('#' + $getapp.attr('id') + ' > .appbutton-folder').each(function (index, element) {
										TweenLite.to(this, .3, { width: notSelected_cardsize, height: notSelected_cardsize, marginLeft: '-=' + (130 * index - 92) + 'px', ease: Power2.easeInOut });
									});
									//TweenLite.to($('#app'), .3, {scale:1, transformOrigin: '50% 50%'});

									//$getapp.isSelected();
									TweenLite.to($getapp, .3, { scaleX: 1.6, scaleY: 1.6, scaleZ: 1.6, z: 0.001, force3D: true, border: '6px #FFF solid', ease: Power4.easeInOut, onComplete: function onComplete() {
											flag = true;
										} });
									level = 1;
								}
								...
								if (mode == "navigation") {
									...
									if (level == 1) {
										...
										if ($getapp.attr('data-type') == "folder") {
											...
											//$getapp.isSelected(1);
											TweenLite.to($getapp, .3, { scaleX: 1, scaleY: 1, scaleZ: 1, z: 0.001, force3D: true, border: '0px #FFF solid', ease: Power4.easeInOut });
											level = 3;
										} else {
											$getapp.notSelected();
											$('#filter').isSelected_setting();
									...
									if (flag) {
										if (mode == "rearrange") {
											...
											if (delete_stage < 2) {
												...
												TweenLite.to($(deletelist[delete_stage]), speed3, { scaleX: 1.3, scaleY: 1.3, scaleZ: 1.3, z: 0.001, force3D: true, ease: Power4.easeInOut, perspective: 1000, onComplete: function onComplete() {
														flag = true;
													} });
												delete_stage++;
											}
