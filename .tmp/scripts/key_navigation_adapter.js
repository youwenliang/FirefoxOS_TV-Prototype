...
(function (exports) {
  ...
  KeyNavigationAdapter.prototype = evt({
    ...
    MOZ_BROWSER_KEY_EVENTS: ['mozbrowserbeforekeydown', 'mozbrowserbeforekeyup', 'mozbrowserafterkeydown', 'mozbrowserafterkeyup'],
    ...
    init: function kna_init(targetElement, options) {
      ...
      this._evtNames.forEach(function (name) {
        return _this._targetElement.addEventListener(name, _this);
      });
    },
    uninit: function kna_uninit() {
      ...
      this._evtNames.foreach(function (name) {
        return _this2._targetElement.removeEventListener(name, _this2);
      });
    },
...
//# sourceMappingURL=key_navigation_adapter.js.map
