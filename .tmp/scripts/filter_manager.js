...
(function (exports) {
   ...
   */
  var FilterManager = function FilterManager() {};
  ...
  FilterManager.prototype = {
    ...
    init: function init(options) {
      ...
      this._smartBubblesElem.addEventListener('all-items-bubbled', this._animationEndHandler);
    },
    ...
    uninit: function uninit() {
      ...
      this._smartBubblesElem.removeEventListener('all-items-bubbled', this._animationEndHandler);
    },
    ...
    _isBubbleSinking: function fm_isBubbleSinking() {
      return this._cardListElem.getAttribute('smart-bubbles-direction') === 'down';
    },
    ...
    _performBubbleUp: function fm_performBubbleUp() {
      if (this._isFirstFrame) {
        ...
        this._smartBubblesElem.play(document.querySelectorAll('#card-list > .card > .app-button'));
      }
    },
    ...
    onAnimationEnd: function fm_onAnimationEnd() {
      ...
      var gotFilteredCardList = function gotFilteredCardList(filteredList) {
        filteredList.forEach(function (card) {
          that._cardScrollable.addNode(that._home.createCardNode(card));
        });
        that._filteredCardList = filter.name !== 'all' ? filteredList : undefined;
      ...
      if (this._isBubbleSinking()) {
        ...
        this._cardManager.getFilteredCardList(filter.name).then(gotFilteredCardList);
      } else {
...
//# sourceMappingURL=filter_manager.js.map
