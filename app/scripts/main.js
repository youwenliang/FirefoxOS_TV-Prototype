	...
	(function( $ ){
   		$.fn.isSelected = function(s) {
    		...
    		if(this.hasClass('cardselected')){
    			...
    			TweenLite.to(this, scale_speed, {border: '4px #FFF solid',borderTop: '4px #FFF solid',borderBottom: '4px #FFF solid',borderLeft: '4px #FFF solid',borderRight: '4px #FFF solid', scaleX:s, scaleY:s, scaleZ:s, z: 0.001, width:'180px', height: '180px', marginLeft: '-=32px', top: '-=32px', zIndex: 10, force3D: true, ease: Power4.easeInOut, perspective: 1000, onComplete:function(){
    				flag = true;
    			}});
    		}
    		else {
   		...
   		$.fn.notSelected = function(s) {
	   		s = s || 1;
				...
				if(this.hasClass('cardselected')){
	    			...
	    			TweenLite.to(this, scale_speed, {border: '0px #FFF solid',borderTop: '0px #FFF solid', borderBottom: '0px #FFF solid', borderLeft: '0px #FFF solid', borderRight: '0px #FFF solid', scaleX:s, scaleY:s, scaleZ:s, z: 0.001, width:'120px', height: '120px', marginLeft: '+=32px', top: '+=32px', zIndex: 1, force3D: true, ease: Power4.easeInOut, onComplete: function(){
						//flag = true;
					}});
	    		}
	    		else {
